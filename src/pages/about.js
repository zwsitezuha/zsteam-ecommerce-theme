      ...
      <div className={styles.root}>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.detailContainer} ref={historyRef}>
            <p>
              Founded in 2018, Zetz is an innovative Bangladesh brand with a
            ...
            <p>
              ...
              that makes T-shirts in its own factory in the BD. And we do this
              in the same factory we have occupied since 2020.
            </p>
          </div>
        </Container>
